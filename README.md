...
This is an [Ansible](https://www.ansible.com/) role which installs [Overseerr](https://overseerr.dev/) to run as a [Docker](https://www.docker.com/) container wrapped in a systemd service.
...
This role configures Overseerr with security in mind by doing the following:
